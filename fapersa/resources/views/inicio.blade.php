...
<!--           <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.html">FAPERSA</a>
          </div> -->
        </div>
      </nav>
      <section class="home-section bg-dark-30" id="home" data-background="assets/images/finance/finance_header_bg.png">
        ...
        <div class="titan-caption">
          <div class="caption-content">
            ...
            <div class="font-alt mb-40 titan-title-size-4">FAPERSA</div>
            <a class="section-scroll btn btn-border-w btn-round" href="/layouts/fabrica">Fábrica</a>
            <a class="section-scroll btn btn-border-w btn-round" href="/layouts/distribuidora">Distribuidora</a>
          </div>
        </div>
      </section>
      <div class="main">
            ...
            <div class="col-xs-12 col-md-6 col-md-offset-6">
              <div class="row finance-image-content">
                <div class="col-md-10 col-md-offset-1">
                  <h2 class="module-title font-alt align-mid">LA EMPRESA</h2>
                  <div class="row multi-columns-row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <p>FAPERSA ICSA fue fundada el 1 de septiembre de 1963, por un grupo empresario dedicado a la comercialización de piezas de automóviles, con capitales nacionales, hace que sus principales pasos bajo licencia y la evaluación de Suko (Alemania).</p>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <p>La exportación en esos años fue de aproximadamente 5% de las ventas y participan México, EE.UU. y Colombia. La superficie ocupada fue 900m2. En los años ochenta, el aumento de las exportaciones subio un 35%, incluidos los clientes de Uruguay, Chile, Brasil y Perú.</p>
                    </div>
                  </div>
                </div>
              </div>
